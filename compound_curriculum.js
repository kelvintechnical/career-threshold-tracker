...
(function () {
  const TIERS = [
    ...
    },
    {
      ...
      cls: "t2",
      projects: [
        ["Hello World .py committed", "Shebang optional, run from terminal, commit message hygiene.", "Junior learner → trainee projects.", "Smallest green CI-ready script pattern."],
        ["Calculator from a tutorial (typed, not pasted)", "Arithmetic, functions, str/int conversion edge cases.", "Trainee software / IT labs.", "Proves you can translate video → repo."],
        ["FizzBuzz with file header comment", "Loops, modulo, commenting conventions.", "Coding screen warm-up literacy.", "Classic filter problem — shows syntax control."],
        ["BMI or input() demo script", "input validation basics, try/except intro.", "Support scripting mindset.", "Interactive CLI is a bridge to automation courses."],
        ["List 5 repos you studied in README", "Citation, learning log, honesty about sources.", "Student / bootcamp track.", "Shows how you consume external material."],
        ["One-page HTML from course (h1 + p)", "Semantic tags, save/open cycle.", "Future PHP/React handoff.", "Static page underpins later templating."],
        ["Change colors with inline or one CSS rule", "Cascade concept, devtools peek optional.", "Frontend awareness.", "Leads into React styling mental model."],
        ["PHP one-liner or note how you’ll install PHP", "When to use server vs static; document blocker if any.", "PHP path realism.", "Honest README beats fake screenshots."],
        ["Connect MySQL locally; screenshot session", "Client tools, host/user, test query SELECT 1.", "Data-backed apps later.", "DB connectivity is core to PHP/MySQL course."],
        ["Notebook or script: load CSV from URL (pandas)", "HTTP CSV, DataFrame head(), kernel vs script.", "Data analyst pipeline start.", "Matches Portilla / Pianalytix workflows."],
        ["Vite + React default app on GitHub", "npm install, npm run dev vs build distinction.", "Frontend toolchain.", "Matches React Mega prerequisites."],
        ["Change default Vite text; push commit", "Component tree locate, hot reload experience.", "Junior React trainee.", "First React commit in portfolio."],
        ["List files in a directory (PowerShell or Python)", "Path objects, iteration, encoding.", "Automation precursor (Sweigart).", "OS integration is ops-friendly signal."],
        ["Read settings.json-style file with json.load", "UTF-8, structure navigation, KeyError awareness.", "Config-driven scripts.", "Pattern for agents/MCP configs later."],
        ["Print one environment variable safely", "os.environ, secrets not committed.", "12-factor lite, DevOps awareness.", "Critical before AWS keys appear."],
        ["Branch: intentional bug → fix → merge PR to self", "Branch naming, diff review, merge.", "Team Git workflow toy version.", "PR history is interview talking point."],
        ["Add .editorconfig from template", "Cross-editor consistency.", "Team standards empathy.", "Small file, high professionalism signal."],
        ["requirements.txt with one pinned library", "pip freeze discipline, reproducible installs.", "Python packaging intro.", "Required for any serious Python repo."],
        ["Tag v0.0.1 on a milestone commit", "Semver story, annotated vs lightweight tags.", "Release thinking.", "Shows you understand versioning."],
        ["CONTRIBUTING.md: how to run your script", "Docs for future you, empathy for readers.", "Open-source hygiene.", "Scales when you invite collaborators."]
      ]
    },
    {
      id: 3,
